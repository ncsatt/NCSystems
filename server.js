...
const NICHES = {
  ...
  'medical-dental': {
    name: 'Medical & Dental',
    headline: "You're with a patient.",
    headlineBreak: "Someone just called to book. They'll hang up and call the next office.",
    heroSub: "Most practices aren't losing patients to bad care. They're losing them to a front-desk workflow that can't handle the volume they already have.",
    heroInev: "The appointment doesn't go to the best provider. It goes to whoever called back first.",
    heroReframe: "I find where that's happening — missed calls, manual reminders, follow-up that never gets sent — and fix it.",
    heroNote: 'Built for dental offices, medical practices, specialist clinics, and independent healthcare providers.',
    heroCta: "I'll show you exactly where this is costing you",
    metrics: [
      { value: '15–25 hrs', label: 'saved per week on calls,\nscheduling & reminders' },
      { value: '30–50%', label: 'reduction in no-shows\nafter automated reminders' },
      { value: '24/7', label: 'patient response without\nadding front desk staff' },
    ],
    reframeHeadline: 'Stop paying staff to do what AI should.',
    reframeBody: "Right now, someone at your front desk is answering the same scheduling questions, sending manual appointment reminders, and chasing patients for follow-up — every single day. That's not a staffing problem. It's an architecture problem. We fix the architecture.",
    painLabel: "What's actually happening",
    pains: [
      { title: 'Phones ring during appointments', body: "You're with a patient. The front desk is busy. Someone calling to book goes to voicemail and doesn't call back. That's a missed appointment before it ever got scheduled." },
      { title: 'Reminder calls are eating hours', body: "Manual reminder calls and confirmation texts for tomorrow's schedule. Same work, every day, handled by a person instead of a system." },
      { title: 'No-shows cost you the slot and the revenue', body: "Patients forget. Without automated reminders and two-way confirmation, no-shows are a daily tax on your schedule — and the slot can't be backfilled in time." },
      { title: 'Recall campaigns never happen', body: "Patients due for a cleaning or follow-up aren't hearing from you because someone has to pull the list and make the calls manually. It gets deprioritized. They go somewhere else." },
    ],
    painCallout: { strong: "You don't have a patient problem.", p: "You have a workflow problem. Every missed call and skipped reminder is an appointment your schedule didn't capture." },
    offersIntro: "Not AI for the sake of it. Replacement of the front-desk work that's eating your staff's day and costing you appointments.",
    services: [
      { tag: 'Scheduling & Response', title: 'Every call and inquiry handled', body: 'Patients get a real response any hour — scheduling, questions, directions, insurance basics — without your front desk picking up the phone.' },
      { tag: 'Reminders & Confirmations', title: 'No-shows become the exception', body: 'Automated appointment reminders, two-way confirmations, and cancellation recovery so your schedule stays full and staff stops making reminder calls.' },
      { tag: 'Recall & Reactivation', title: 'Patients who lapsed come back', body: 'Automated recall for overdue cleanings, annual checkups, and follow-up care — running in the background without anyone pulling a list or making calls.' },
      { tag: 'Operations', title: 'Admin that runs itself', body: 'Intake form collection, post-visit instructions, insurance pre-auth follow-up — the repetitive coordination that currently runs on staff time.' },
    ],
    offerCallout: { strong: "The goal isn't fewer staff.", p: "It's freeing your staff from repetitive work so they can focus on patients instead of phones." },
    authoritySignal: "Most practices underestimate how many appointments are lost before the first callback.",
    howWorks: [
      { title: 'Discovery & audit', body: "We map your front-desk workflow to find exactly where appointments are being lost. Where are calls going unanswered? What's manual that shouldn't be? What's the real cost of the current setup?" },
      { title: 'Build & prove it', body: "We build a working system tailored to your practice. You see it handle real scheduling scenarios, reminder sequences, and recall flows before any major commitment." },
      { title: 'Deploy & scale', body: "Live in 2–6 weeks. Staff gets time back. No-show rates drop. Recall runs automatically. We stay engaged to optimize and expand as your needs grow." },
    ],
    howWorksCallout: { strong: 'Everything that used to be manual runs in the background.' },
    proofs: [
      { strong: "What practices usually underestimate", p: "How many patients call once, don't leave a message, and book elsewhere — and how many no-shows could have been prevented with an automated reminder sequence." },
      { strong: 'What changes when the workflow gets fixed', p: "Fewer missed calls, more confirmed appointments, recall running automatically, and front desk staff focused on patients in the office instead of the phone." },
      { strong: 'The real result', p: 'Same patient volume. More appointments kept. Less manual work holding the schedule together.' },
    ],
    ...
    ctaHeadline: "I'll show you where your practice is losing appointments",
    ctaSub: "30 minutes. No pitch. I'll map your front-desk workflow, find where patients are falling off, and show you what fixing it looks like — with real numbers.",
    ctaList: ["— where calls are going unanswered", "— what reminder and recall work should be automated", "— what the fix costs vs. what the problem costs", "— what a live system would look like in your practice"],
  },

  'insurance': {
    name: 'Insurance Agencies',
    headline: "A prospect requests a quote.",
    headlineBreak: "You respond Tuesday. They bound coverage Monday.",
    heroSub: "Most insurance agencies aren't losing business to better coverage. They're losing it to a follow-up workflow that can't keep pace with the leads they already get.",
    heroInev: "The policy doesn't go to the best agent. It goes to whoever followed up.",
    heroReframe: "I find where that's happening — quotes going cold, renewals slipping, manual follow-up holding the book together — and fix it.",
    heroNote: 'Built for independent agencies, captive agents, and brokers managing personal and commercial lines.',
    heroCta: "I'll show you exactly where this is costing you",
    metrics: [
      { value: '10–20 hrs', label: 'saved per week on follow-up,\nrenewals & admin' },
      { value: '40–60%', label: 'of leads go cold without\nsame-day follow-up' },
      { value: '24/7', label: 'quote response without\nadding staff' },
    ],
    reframeHeadline: 'Stop paying staff to do what AI should.',
    reframeBody: "Right now, someone at your agency is manually following up on quote requests, sending renewal reminders, and chasing clients for policy documents — every single day. That's not a capacity problem. It's an architecture problem. We fix the architecture.",
    painLabel: "What's actually happening",
    pains: [
      { title: 'Quote requests sit in the queue', body: "Leads come in through the website, referrals, or aggregators. Someone has to follow up. By the time they do, the prospect has already heard from two other agents and made a decision." },
      { title: 'Renewals slip through without outreach', body: "Policy renewals require proactive contact. When that contact is manual, some renewals don't happen — and clients leave without you ever knowing a conversation could have kept them." },
      { title: 'Cross-sell opportunities disappear', body: "Clients with auto should hear about home. Clients with home should hear about umbrella. Without a system, those conversations only happen when someone remembers — which isn't often enough." },
      { title: 'Document collection drags every new policy', body: "Getting signed applications, supporting documents, and payment info from clients is a multi-touch manual process that stalls every new policy and wastes staff time on follow-up." },
    ],
    painCallout: { strong: "You don't have a leads problem.", p: "You have a follow-up problem. Every day a quote sits unanswered, someone else is binding that policy." },
    offersIntro: "Not AI for the sake of it. Replacement of the manual follow-up and admin work that's costing you premium.",
    services: [
      { tag: 'Lead Response', title: 'Every quote request answered instantly', body: "Any channel, any hour. Prospects get real engagement and a clear path to a quote before they've had time to call your competitor." },
      { tag: 'Renewal Management', title: 'Renewals that run automatically', body: 'Proactive renewal outreach, multi-touch follow-up sequences, and payment reminders — running without anyone working a list or watching a calendar.' },
      { tag: 'Cross-sell & Retention', title: 'More premium from the book you already have', body: 'Automated cross-sell sequences, annual review prompts, and reactivation for lapsed clients — compounding revenue from clients you already wrote.' },
      { tag: 'Operations', title: 'Document collection on autopilot', body: 'Signed apps, supporting documents, payment collection — multi-touch follow-up that moves every new policy forward without your staff chasing it.' },
    ],
    offerCallout: { strong: "The goal isn't more leads.", p: "It's converting the ones you already have — and keeping the clients you already wrote." },
    authoritySignal: "Most agencies don't realize how much premium walks out the door between the first inquiry and the first callback.",
    howWorks: [
      { title: 'Discovery & audit', body: "We map your agency's workflow to find exactly where leads and renewals are slipping. Where are quotes going cold? What renewal outreach isn't happening? What's the real cost of the current setup?" },
      { title: 'Build & prove it', body: "We build a working lead response, renewal, and document collection system around your actual workflows. You see it running before any major commitment." },
      { title: 'Deploy & scale', body: "Live in 2–6 weeks. Quotes get answered. Renewals run. Cross-sell happens. We stay engaged to optimize and expand as your book grows." },
    ],
    howWorksCallout: { strong: 'Everything that used to be manual runs in the background.' },
    proofs: [
      { strong: "What agencies usually underestimate", p: "How many quote requests go cold before the first follow-up — and how much renewal premium is lost to clients who simply never heard back at the right time." },
      { strong: 'What changes when the workflow gets fixed', p: "More quotes convert, renewals run without anyone working the list, cross-sell happens automatically, and staff focuses on clients instead of follow-up." },
      { strong: 'The real result', p: 'Same book of business. More premium retained. Less manual work holding the agency together.' },
    ],
    ...
    ctaHeadline: "I'll show you where your agency is losing premium",
    ctaSub: "30 minutes. No pitch. I'll map your follow-up workflow, find where leads and renewals are slipping, and show you what fixing it looks like — with real numbers.",
    ctaList: ["— where quote requests are going cold", "— what renewal and cross-sell work should be automated", "— what the fix costs vs. what the problem costs", "— what a live system would look like in your agency"],
  },
};
